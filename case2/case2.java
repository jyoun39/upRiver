...
public class case2 extends StarMacro {
    public void execute() {
       execute0();
       execute1();
       execute2();
  ...
  private void execute0() {
    ...
    scalarGlobalParameter_6.getQuantity().setValueAndUnits(-10, units_0);
  }
  ...
  private void execute2() {
    ...
    scalarGlobalParameter_6.getQuantity().setValueAndUnits(0.2, units_0);
  }
